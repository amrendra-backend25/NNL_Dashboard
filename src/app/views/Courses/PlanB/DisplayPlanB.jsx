...
import UploadModalPlanB from './UploadModalPlanB';
import EditModalPlanB from './EditModalPlanB';
...
const DisplayPlanA = () => {
  ...
  return (
    <Container>
      ...
      <UploadModalPlanB show={modalShow} onHide={() => setModalShow(false)} />
      <EditModalPlanB show={modalShow1} onHide={() => setModalShow1(false)} />
