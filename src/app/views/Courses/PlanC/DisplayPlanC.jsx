...
import UploadModalPlanC from './UploadModalPlanC';
import EditModalPlanC from './EditModalPlanC';
...
const DisplayPlanC = () => {
  ...
  return (
    <Container>
      ...
      <UploadModalPlanC show={modalShow} onHide={() => setModalShow(false)} />
      <EditModalPlanC show={modalShow1} onHide={() => setModalShow1(false)} />
            ...
            return (
              <>
                <MDBTableBody>
                  <tr>
                    <td>
                      <p className="fw-normal mb-1">Plan C+ - Mastermind Pack 3.0</p>
                    </td>
                    <td>
                      <img src="" alt="Image" />
                    </td>
                    <td>
                      <p className="fw-normal mb-1">
                        The ONE-IN-ALL, ALL-IN-ONE Pack Covering TOP-
                      </p>
                    </td>
